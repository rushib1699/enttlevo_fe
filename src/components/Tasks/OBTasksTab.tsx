...
const OBTasksTab = ({ accountId, companyId, userId }: TasksProps) => {
    ...
    const fetchTasks = async () => {
        ...
        setIsLoading(true);
        try {
            const response = await getActivitiesByCompanyId({
    ...
    const handleCreateTask = async (data: any) => {
        ...
        try {
            ...
            await createActivityByCompanyId({
                activity: data.title,
                user_id: userId,
                leads_id: Number(accountId),
    ...
    const handleUpdateTask = async (data: any) => {
        ...
        setIsUpdating(true);
        try {
            await updateActivityByCompanyId({
